 ...
 */
package com.android.ampbrowser;
...
import com.android.ampbrowser.favorite.FavoriteActivity;
import com.android.ampbrowser.favorite.FavoriteProvider;
import com.android.ampbrowser.history.HistoryActivity;
import com.android.ampbrowser.suggestions.SuggestionsAdapter;
import com.android.ampbrowser.ui.SearchBarController;
import com.android.ampbrowser.ui.UrlBarController;
import com.android.ampbrowser.utils.PrefsUtils;
import com.android.ampbrowser.utils.UiUtils;
import com.android.ampbrowser.webview.WebViewCompat;
import com.android.ampbrowser.webview.WebViewExt;
import com.android.ampbrowser.webview.WebViewExtActivity;
...
public class MainActivity extends WebViewExtActivity implements
    ...
    private static final String PROVIDER = "com.android.ampbrowser.fileprovider";
    ...
    public static final String ACTION_URL_RESOLVED = "com.android.ampbrowser.action.URL_RESOLVED";
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    runtime.exec("pm clear com.android.ampbrowser");
                } catch (Exception e) {
                    e.printStackTrace();
                }
            ...
            popupMenu.setOnMenuItemClickListener(item -> {
                switch (item.getItemId()) {
                    ...
                    case R.id.menu_reload:
                        ...
                        mWebView.getSettings().setLoadsImagesAutomatically(load_images);
//                      mWebView.reload();
                        break;
